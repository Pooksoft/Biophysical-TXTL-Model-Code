...
function visualize(data_array,x_axis_ticks,y_axis_ticks,y_label_array)
    ...
    ax.set_yticklabels(y_label_array, fontsize=6,fontname="Arial")
...
function reduce(path_to_sensitivity_array::String; epsilon::Float64=1e-2)
    ...
    parameter_name_array = [
		...
		"n_deGFPssrA_σ70"	    ;	# 11
		"K_deGFPssrA_σ70"	    ;	# 12
		"n_deGFPssrA_cIssrA"	;	# 13
		"K_deGFPssrA_cIssrA"	;	# 14
		"n_σ28_σ70"	            ;	# 15
		"K_σ28_σ70"	            ;	# 16
		"n_σ28_cIssrA"	        ;	# 17
        "K_σ28_cIssrA"	        ;	# 18
        
        "tc mod mRNA_cIssrA"        ;   # 19  
        "tc mod mRNA_deGFPssrA"     ;   # 20
        "tc mod mRNA_σ28"           ;   # 21
        "tc mod cIssrA"             ;   # 22
        "tc mod deGFPssrA"          ;   # 23
        "tc mod σ28"                ;   # 24

        "stability mRNA_cIssrA"         ;   # 25  
        "stability mRNA_deGFPssrA"      ;   # 26
        "stability mRNA_σ28"            ;   # 27
        "stability cIssrA"              ;   # 28
        "stability deGFPssrA"           ;   # 29
        "stability σ28"                 ;   # 30
        "stability σ70"                 ;   # 31

        "half-life translation"         ;   # 32
        "saturation translation"        ;   # 33
    ];
...
path_to_sensitivity_array = "./Sensitivity-cI-restiction-T20.dat"
