...
function plot_prot_C1ssrA_data(time_array, simulation_data_array,experimental_data_dictionary)
    ...
    # write -
    savefig("./plots/Prot-C1ssrA-Ensemble.pdf", facecolor=fig.get_facecolor(), edgecolor="none")
end
...
function main(path_to_simulation_dir::String, path_to_plot_file::String)
    ...
    # plot -
    plot_prot_C1ssrA_data(time_array, data_array, exp_dd)
end
